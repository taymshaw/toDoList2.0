...
class ToDoList extends React.Component {
    ...
    fetchTasks() {
        fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=1083")
        .then(checkStatus)
        .then(json)
        .then((response) => {
    ...
    deleteTask(id) {
        ...
        fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}?api_key=1083`, {
            method: "DELETE",
            mode: "cors",
        }).then(checkStatus)
        .then(json)
    ...
    toggleComplete(id, completed) {
        ...
        fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}/mark_${newState}?api_key=1083`, {
            method: "PUT",
            mode: "cors",
        }).then(checkStatus)
        .then(json)
